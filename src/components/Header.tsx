      ...
      <div className="container mx-auto flex items-center justify-between py-4 px-4 lg:px-8">
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          <a
            ...
            className="flex items-center gap-1 lg:gap-2 px-2 lg:px-6 py-1.5 lg:py-3 text-xs lg:text-base font-semibold text-secondary border border-secondary hover:bg-secondary/10 transition-colors"
          ...
          <button
            ...
            className="px-2 lg:px-6 py-1.5 lg:py-3 text-xs lg:text-base font-semibold hover:opacity-90 transition-opacity"
