...
const navLinks = [
  { label: "Home", href: "/" },
  {
    ...
    children: [
      ...
      { label: "Classic Lawn Maintenance", href: "/services/classic-lawn" },
      { label: "Premium Lawn Maintenance", href: "/services/premium-lawn" },
      { label: "Ultimate Maintenance", href: "/services/ultimate-maintenance" },
      { label: "A La Carte", isHeader: true },
      { label: "Mulch & Sod Installs", href: "/services/mulch-sod" },
      { label: "Planting", href: "/services/planting" },
      { label: "Tree/Shrub Cut, Removal, or Trim", href: "/services/tree-shrub" },
      { label: "The MORE Factor", isHeader: true },
      { label: "Pressure Washing", href: "/services/pressure-washing" },
      { label: "Gutter Cleaning", href: "/services/gutter-cleaning" },
      { label: "Roof & Yard Leaf/Debris", href: "/services/roof-debris" },
      { label: "Trash Out / Clean-Outs", href: "/services/trash-out" },
