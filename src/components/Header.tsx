...
const navLinks = [
  { label: "Home", href: "/" },
  {
    ...
    children: [
      ...
      { label: "Classic Lawn Maintenance", href: "/services/lawn-landscape" },
      { label: "Premium Lawn Maintenance", href: "/services/lawn-landscape" },
      { label: "Ultimate Maintenance", href: "/services/lawn-landscape" },
      { label: "A La Carte", isHeader: true },
      { label: "Mulch & Sod Installs", href: "/services/lawn-landscape" },
      { label: "Planting", href: "/services/lawn-landscape" },
      { label: "Tree/Shrub Cut, Removal, or Trim", href: "/services/lawn-landscape" },
      { label: "The MORE Factor", isHeader: true },
      { label: "Pressure Washing", href: "/services/debris-removal" },
      { label: "Gutter Cleaning", href: "/services/debris-removal" },
      { label: "Roof & Yard Leaf/Debris", href: "/services/debris-removal" },
      { label: "Trash Out / Clean-Outs", href: "/services/debris-removal" },
                    ...
                    <AnimatePresence>
                      {mobileDropdown === link.label && (
                        ...
                        >
                          {link.children.map((child) =>
                            'isHeader' in child && child.isHeader ? (
                              <div key={child.label} className="pl-4 pt-3 pb-1 text-xs font-bold uppercase tracking-wider text-secondary/80 first:pt-1">
                                {child.label}
                              </div>
                            ) : (
                              <a
                                ...
                                className="block pl-6 py-2 text-base text-primary-foreground/70 hover:text-primary-foreground transition-colors"
                              >
                                {child.label}
                              </a>
                            )
